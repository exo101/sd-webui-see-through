...
from common.utils.torchcv import pad_rgb_torch
from common.utils.torch_utils import img2tensor
...
class MarigoldDepthPipeline(DiffusionPipeline):
    ...
    def single_infer(
        ...
        # Convert cond_latent to match UNet dtype (important for NF4 quantized models)
        cond_latent = cond_latent.to(dtype=self.unet.dtype)
        ...
        for i, t in iterable:
            ...
            # Convert input to match UNet dtype (important for NF4 quantized models)
