...
2. 插件下载到WebUI的extensions文件夹中
   
3. 插件模型目录：sd-webui-forge-neo-v2\webui\extensions\sd-webui-see-through\see-through\models\（透明图层模型） seethroughv0.0.2_layerdiff3d （深度分析模型） seethroughv0.0.1_marigold，
 
4. 插件模型：sd-webui-forge-neo-v2\webui\models\diffusers\（修复补全模型）models--frankjoshua--juggernautXL_version6Rundiffusion
 
5. ui界面启用See-Through插件
